...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    //formatNumber: kvLookup('formatNumber', config, dataset, false),//20170502 김경환
    formatNumber: kvLookup('formatNumber', config, dataset, true, 'float'),
...
console.log("justgage.js noGradient[" + obj.config.noGradient + "]");
  // gauge
